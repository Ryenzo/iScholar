...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $recommendationLetterPath = uploadFile('recommendation', $uploadDir);
  ...
  do {
    ...
    $sql = "INSERT INTO campus_leaders
      (name, email, phone, address, application_form, form9, cert_ranking, recommendation, grades_cert)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    $successMessage = "Campus leader application submitted successfully!";
...
<div class="main-content">
  ...
  <h1 class="mb-4 text-center fw-bold" style="color:#dc3545;">Campus Leaders/Journalists Benefits</h1>
  ...
  <div class="card p-4 mx-auto shadow" style="max-width: 1000px;">
    ...
    <div class="col-md-6">
      ...
      <div class="mb-3">
        <label class="form-label" for="recommendation">Recommendation from the chair of student leadership</label>
        <input type="file" class="form-control" id="recommendation" name="recommendation" accept=".pdf,.jpg,.jpeg,.png">
      </div>
      <div class="mb-3">
        <label class="form-label" for="grades_cert">Certificate of grades issued by the registrar</label>
        <input type="file" class="form-control" id="grades_cert" name="grades_cert" accept=".pdf,.jpg,.jpeg,.png">
      </div>
    </div>
    </div>
      <?php
