...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $birthCertPath         = uploadFile('birth_cert', $uploadDir);
  $registrationFormPath  = uploadFile('registration_form', $uploadDir);
  ...
  do {
    ...
    $sql = "INSERT INTO scholarship_applications
      (name, email, phone, address, application_form, letter, form9, passport_pic, birth_cert, 
       registration_form, alumni_id, employment_cert, status)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
<div class="main-content">
  ...
  <h1 class="mb-4 text-center fw-bold" style="color:#dc3545;">Pandemic Assistance Discounts</h1>
  ...
  <div class="card p-4 mx-auto shadow" style="max-width: 1000px;">
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        <div class="mb-3">
        <label class="form-label" for="registration_form">Photocopy of Registration Form</label>
        <input type="file" class="form-control" id="registration_form" name="registration_form" accept=".pdf,.jpg,.jpeg,.png">
        </div>
        <div class="mb-3">
        <label class="form-label" for="alumni_id">Photocopy of Alumni I.D.</label>
        <input type="file" class="form-control" id="alumni_id" name="alumni_id" accept=".pdf,.jpg,.jpeg,.png">
        </div>
        <div class="mb-3">
        <label class="form-label" for="employment_cert">Certificate of Employment/contract for OFW and Frontliners</label>
        <input type="file" class="form-control" id="employment_cert" name="employment_cert" accept=".pdf,.jpg,.jpeg,.png">
        </div>
      <?php
