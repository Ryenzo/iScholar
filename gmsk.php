...
<div class="main-content">
  ...
  <h1 class="mb-4 text-center fw-bold" style="color:#dc3545;">Guro Mo, Sagot Ko</h1>
  ...
  <div class="card p-4 mx-auto shadow" style="max-width: 1000px;">
    ...
    <div class="col-md-6">
      ...
      <div class="mb-3">
        <label class="form-label" for="good_moral_cert">Photocopy certificate of good moral character</label>
        <input type="file" class="form-control" id="good_moral_cert" name="good_moral_cert" accept=".pdf,.jpg,.jpeg,.png">
      </div>
    </div>
      <?php
