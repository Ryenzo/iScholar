...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $letterToDrAndamanPath  = uploadFile('letter_to_dr_andaman', $uploadDir);
  $form9Path              = uploadFile('form9', $uploadDir);
  $recommendationISPSPath = uploadFile('recommendation_isps', $uploadDir);
  ...
  do {
    ...
    $sql = "INSERT INTO student_athletes
      (name, email, phone, address, application_form, letter_to_dr_andaman, form9, recommendation_isps, grades_cert, passport_pic, status)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
<div class="main-content">
  ...
  <h1 class="mb-4 text-center fw-bold" style="color:#dc3545;">Student Athletes’ Benefits</h1>
  ...
  <div class="card p-4 mx-auto shadow" style="max-width: 1000px;">
    ...
    <div class="col-md-6">
      ...
      <div class="mb-3">
        <label class="form-label" for="letter_addressed">Letter addressed to: Dr. Gregorio A. Andaman, Jr., MHA</label>
        <input type="file" class="form-control" id="letter_addressed" name="letter_addressed" accept=".pdf,.jpg,.jpeg,.png">
      </div>
      <div class="mb-3">
      ...
      <div class="mb-3">
        <label class="form-label" for="recommendation">Recommendation from the institutional student program & services</label>
        <input type="file" class="form-control" id="recommendation" name="recommendation" accept=".pdf,.jpg,.jpeg,.png">
      </div>
      <div class="mb-3">
        <label class="form-label" for="cert_grades">Certificate of grades issued by the registrar</label>
        <input type="file" class="form-control" id="cert_grades" name="cert_grades" accept=".pdf,.jpg,.jpeg,.png">
      </div>
      <div class="mb-3">
