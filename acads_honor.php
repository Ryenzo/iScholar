...
<div class="main-content">
  ...
  <h1 class="mb-4 text-center fw-bold" style="color:#dc3545;">Academic Honors</h1>
  ...
  <div class="card p-4 mx-auto shadow" style="max-width: 1000px;">
    ...
    <div class="col-md-6">
      ...
      <div class="mb-3">
      <label class="form-label" for="good_moral">Photocopy certificate of good moral character</label>
